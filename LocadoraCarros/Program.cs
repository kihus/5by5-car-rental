...
void RegisterClient(string op)
{
    switch (op)
    {
        case "1":
            ...
            var individual = new Individual(clientIdGeneratorService.GenerateId(), name, surname, birthDate, adress, EClientType.Individual, cpf);
        ...
        case "2":
            ...
            var legalEntity = new LegalEntity(clientIdGeneratorService.GenerateId(), name, surname, birthDate, adress, EClientType.Individual, cnpj);
...
void SearchClient(string op)
{
    switch (op)
    {
        ...
        case "3":
            ...
            if(rentalManager.ClientManager.GetById(id) == null)
            {
                Console.WriteLine("Not found");
            }

            var idClient = rentalManager.ClientManager.GetById(id);
...
void RegisterVehicle(string op)
{
    switch (op)
    {
        ...
        case "1":
            ...
            EColor color = (EColor)int.Parse(Console.ReadLine());
            ...
            var motorcycle = new Motorcycle(vehicleIdGeneratorService.GenerateId(), model, manufacturer, manufacturerYear, color, dailyRentalPrice, mileage, EVehicleType.Motocycle, licensePlate, cc, storageBox, isAutomatic);
        ...
        case "2":
            ...
            Console.Write("Color: (1 - Red | 2 - Green | 3 - Blue | 4 - Black | 5 - White | 6 - Silver | 7 - Other)");
            color = (EColor)int.Parse(Console.ReadLine());
            ...
            var car = new Car(vehicleIdGeneratorService.GenerateId(), model, manufacturer, manufacturerYear, color, dailyRentalPrice, mileage, EVehicleType.Car, licensePlate, numberOfDoors, passengerCapacity, trunkCapacityLiters, airConditioning);
            rentalManager.VehicleManager.AddCar(car);
            break;
        ...
        case "3":
            ...
            var truck = new Truck(vehicleIdGeneratorService.GenerateId(), model, manufacturer, manufacturerYear, color, dailyRentalPrice, mileage, EVehicleType.Truck, licensePlate, loadCapacityTons, numberOfAxels, fuelConsumption);
            rentalManager.VehicleManager.AddTruck(truck);
            break;
        case "0":
